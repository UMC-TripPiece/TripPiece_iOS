...
class TabBar: UITabBarController {
    ...
    func setTabBar() {
        ...
        let vc1 = UINavigationController(rootViewController: WorldVC())
...
//        let vc3 = UINavigationController(rootViewController: ExploreVC())
//        vc3.tabBarItem = UITabBarItem(title: "탐색", image: UIImage(named: "Explore"), tag: 3)
        ...
        vc4.tabBarItem = UITabBarItem(title: "마이페이지", image: UIImage(named: "User"), tag: 3)
    ...
    func appearance() {
        ...
        self.tabBar.itemSpacing = DynamicPadding.dynamicValue(55)
    }
    
    override func viewDidLayoutSubviews() {
        super.viewDidLayoutSubviews()
        var tabFrame = tabBar.frame
        tabFrame.size.height = DynamicPadding.dynamicValue(100)
        tabFrame.origin.y = view.frame.size.height - DynamicPadding.dynamicValue(100)
