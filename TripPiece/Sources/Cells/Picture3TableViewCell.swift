...
class Picture3TableViewCell: UITableViewCell {
    ...
    private lazy var underImagesStackView: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [imageView2, imageView3])
    ...
    private lazy var imagesStackView: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [imageView1, underImagesStackView])
