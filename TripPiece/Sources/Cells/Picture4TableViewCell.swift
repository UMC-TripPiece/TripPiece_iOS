...
class Picture4TableViewCell: UITableViewCell {
    ...
    private lazy var imageView3: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "ootdImage3")
        imageView.contentMode = .scaleAspectFit
        return imageView
    }()
    private lazy var imageView4: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "ootdImage4")
        imageView.contentMode = .scaleAspectFit
        return imageView
    }()
    ...
    // 밑에 두개 이미지
    private lazy var underImagesStackView: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [imageView3, imageView4])
        stackView.axis = .horizontal
        stackView.spacing = 16
        stackView.distribution = .fillEqually
        return stackView
    ...
    private lazy var imagesStackView: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [topImagesStackView, underImagesStackView])
    ...
    func initializeCell(travelsDetailInfo: TravelsDetailInfo) {
        ...
        let imageViews: [UIImageView] = [imageView1, imageView2, imageView3, imageView4]
        for i in 0..<4 {
