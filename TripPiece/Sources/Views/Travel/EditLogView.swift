...
class LogEditNavigationBar: UINavigationBar {
...
final class EditLogView: UIView {
    
    // MARK: - UI 프로퍼티
    
    lazy var startNavBar: LogEditNavigationBar = {
        let nav = LogEditNavigationBar()
    ...
    lazy var startLogButton: UIButton = {
        let button = UIButton(type: .system)
        button.setTitle("편집 완료", for: .normal)
